  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:ring-turquoise-500 disabled:pointer-events-none disabled:opacity-50 shadow-sm",
        
        // Variants
        variant === "default" && "bg-turquoise-600 text-white hover:bg-turquoise-700",
